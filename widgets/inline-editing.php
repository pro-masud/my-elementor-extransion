...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'pro_masud_ex' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'pro_masud_ex' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'pro_masud_ex' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'pro_masud_ex' ),
			]
		);
